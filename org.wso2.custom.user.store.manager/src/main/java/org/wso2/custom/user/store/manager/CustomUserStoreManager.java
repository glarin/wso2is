...
//paring the SELECT_USER_SQL from user_mgt.xml
			...
			throw new UserStoreException(
					"Authentication Failure. Using sql :" + sqlstmt + " " + password + " " + storedPassword);
		} finally {
	...
	/*
	 * @Override public Map<String, String> doGetUserClaimValues(String userName,
	 * String[] claims, String domainName) throws UserStoreException { return new
	 * HashMap<String, String>(); }
	 */
	/*
	 * @Override public String doGetUserClaimValue(String userName, String claim,
	 * String profileName) throws UserStoreException { return null; }
	 */
	@Override
	...
	public org.wso2.carbon.user.api.Properties getDefaultUserStoreProperties() {
		...
		properties.setMandatoryProperties(CustomUserStoreConstants.CUSTOM_UM_MANDATORY_PROPERTIES
				.toArray(new Property[CustomUserStoreConstants.CUSTOM_UM_MANDATORY_PROPERTIES.size()]));
		properties.setOptionalProperties(CustomUserStoreConstants.CUSTOM_UM_OPTIONAL_PROPERTIES
				.toArray(new Property[CustomUserStoreConstants.CUSTOM_UM_OPTIONAL_PROPERTIES.size()]));
		properties.setAdvancedProperties(CustomUserStoreConstants.CUSTOM_UM_ADVANCED_PROPERTIES
				.toArray(new Property[CustomUserStoreConstants.CUSTOM_UM_ADVANCED_PROPERTIES.size()]));
		return properties;
	}
}